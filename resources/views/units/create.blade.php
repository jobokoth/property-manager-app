                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('units.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('floor') is-invalid @enderror" id="floor" name="floor" value="{{ old('floor') }}">
                            @error('floor')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('water_rate_mode') is-invalid @enderror" id="water_rate_mode" name="water_rate_mode" required>
                                <option value="per_unit" {{ old('water_rate_mode') == 'per_unit' ? 'selected' : '' }}>Per Unit</option>
                                <option value="per_meter" {{ old('water_rate_mode') == 'per_meter' ? 'selected' : '' }}>Per Meter</option>
                            </select>
