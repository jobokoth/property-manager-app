                ...
                <div class="card-body">
                    <form action="{{ route('caretakers.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @if($properties->isEmpty())
                                <div class="alert alert-warning">
                                    ...
                                    No properties available. You must have at least one property to assign a caretaker.
                                </div>
                            @else
                                <div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" {{ $properties->isEmpty() ? 'disabled' : '' }}>Create Caretaker</button>
                        </div>
                    </form>
                </div>
            </div>
